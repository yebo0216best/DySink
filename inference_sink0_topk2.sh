# Configuration
CONFIG_PATH="configs/inference_sink0_topk2.yaml"
SCRIPT_PATH="inference_with_memory_eb.py"
MASTER_PORT=29504
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: bash interactive_inference_with_memory_eb.sh [--multi-gpu NUM_GPUS] [--config CONFIG_PATH] [--port MASTER_PORT]"
            exit 1
            ;;
    esac
done
...
# Print configuration
echo "============================================================================"
echo "LongLive Inference with Memory KV Cache (PE-Core Vision Encoder)"
echo "============================================================================"
